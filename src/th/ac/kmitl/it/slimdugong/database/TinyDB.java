...
public class TinyDB {
	...
	public TinyDB(Context appContext, String name, int mode) {
		mContext = appContext;
		preferences = mContext.getSharedPreferences(name, mode);
	}
...
//	}
//	
//	public Date getDate(String key, Date value) throws ParseException{
//		DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
//		return dateFormat.parse(preferences.getString(key, ""));
//	}
